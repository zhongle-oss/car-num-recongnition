...
data_path = '/Users/zhongle/Downloads/car_num-master/data'
...
label = 0
LABEL_temp = {}
if(os.path.exists('/Users/zhongle/Downloads/car_num-master/train_data.list')):
    os.remove('/Users/zhongle/Downloads/car_num-master/train_data.list')
if(os.path.exists('/Users/zhongle/Downloads/car_num-master/test_data.list')):
    os.remove('/Users/zhongle/Downloads/car_num-master/test_data.list')
for character_folder in character_folders:
    with open('/Users/zhongle/Downloads/car_num-master/train_data.list', 'a') as f_train:
        with open('/Users/zhongle/Downloads/car_num-master/test_data.list', 'a') as f_test:
...
test_image_paths = []
test_image_labels = []
with open('/Users/zhongle/Downloads/car_num-master/train_data.list', 'r') as f:
    lines = f.readlines()
    for line in lines:
        img, label = line.split('\t')
        all_image_paths.append(img)
        all_image_labels.append(int(label))
with open('/Users/zhongle/Downloads/car_num-master/test_data.list', 'r') as f:
    lines = f.readlines()
    for line in lines:
        img, label = line.split('\t')
